...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i3.Espisode) {
      return _i3.Espisode.fromJson(data, this) as T;
    }
    if (t == _i4.Example) {
    ...
    if (t == _i1.getType<_i3.Espisode?>()) {
      return (data != null ? _i3.Espisode.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i4.Example?>()) {
      return (data != null ? _i4.Example.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<List<_i5.Espisode>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i5.Espisode>(e)).toList()
          : null) as dynamic;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'Espisode') {
      return deserialize<_i3.Espisode>(data['data']);
    }
